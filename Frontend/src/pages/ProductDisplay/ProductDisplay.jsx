      ...
      <div class="lg:max-w-6xl max-w-xl mx-auto">
        <div class="grid items-start grid-cols-1 lg:grid-cols-2 gap-8 max-lg:gap-12 max-sm:gap-8">
          ...
          <div class="w-full">
            ...
            <div>
              <h3 class="text-lg sm:text-xl font-bold text-gray-800">Sizes</h3>
              <div class="flex flex-wrap gap-4 mt-4">
                <button
                  type="button"
                  class="w-10 h-9 border border-gray-300 hover:border-blue-600 text-sm  flex items-center justify-center shrink-0"
                >
                  SM
                </button>
                <button
                  type="button"
                  class="w-10 h-9 border border-blue-600 hover:border-blue-600 text-sm  flex items-center justify-center shrink-0"
                >
                  MD
                </button>
                <button
            ...
            <div>
              ...
              <div class="flex items-center gap-2 mt-4 max-w-sm">
                ...
                <button
                  type="button"
                  class="border-0 outline-0 bg-blue-600 hover:bg-blue-700 text-white  px-4 py-2.5 text-sm"
                >
                  Apply
                </button>
              </div>
            ...
            <div>
              ...
              <div class="flex items-center flex-wrap gap-4 mt-4">
                <h4 class="text-2xl sm:text-3xl text-gray-800 font-semibold">
                  4.0 / 5
                </h4>
            ...
            <div class="mt-6">
              ...
              <a
                ...
                class="block text-blue-600 hover:underline text-sm mt-6 font-semibold"
              >
                Read all reviews
              </a>
            </div>
